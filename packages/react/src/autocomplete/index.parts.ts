...
export { AutocompleteAssistiveHint as AssistiveHint } from './assistive-hint/AutocompleteAssistiveHint';
...
export { AutocompleteStatus as Status } from './status/AutocompleteStatus';
